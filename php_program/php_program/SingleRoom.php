    ...
    <section class="gallery" id="gallery">
        <div class="swiper gallery-slider">
            <div class="swiper-wrapper">
                <img src="css/singleroom1.jpg" class="swiper-slide" alt="">
                <img src="css/singleroom2.jpg" class="swiper-slide" alt="">
                <img src="css/singleroom3.jpg" class="swiper-slide" alt="">
                <img src="css/singleroom4.jpg" class="swiper-slide" alt="">
                <img src="css/singleroom5.jpg" class="swiper-slide" alt="">
            </div>
  ...
  var swiper = new Swiper(".gallery-slider",{
                                ...
                                <div class="inner">
                                    ...
                                    <div class="room-price">
                                        <div class="price-head">
                                            ...
                                            <span class="price-value" style="text-decoration: line-through;">$25 / Night</span>
                                            <span class="price-value" style="color:red">$20/ Night</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h3>Bed</h3>
                                                <span><i class="fa-solid fa-gem"></i> 1 Modern bed</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h3>Max guest</h3>
                                                <span><i class="fa-solid fa-gem"></i> 1 Guest</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h3>Room space</h3>
                                                <span><i class="fa-solid fa-gem"></i> 15m<sup>2</sup></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <div class="desc">
        ...
        <p style="text-align: justify;">
            Our comfortable single rooms are just the right size if you are travelling alone. Similar to all the other rooms in the Amsterdam Forest Hotel, the single room is fully equipped with all comforts. In addition to the comfortable hotel lounge, the room is equipped with a Smart TV, Wi-Fi and iPod docking station. With a size of 15 m², our single rooms offer all the space and comfort you need during your stay in Amsterdam.
        </p>
        <p></p>
    </div>
