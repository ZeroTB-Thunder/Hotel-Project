    ...
    <section class="gallery" id="gallery">
        <div class="swiper gallery-slider">
            <div class="swiper-wrapper">
                <img src="css/vr1.jpg" class="swiper-slide" alt="">
                <img src="css/vr2.jpg" class="swiper-slide" alt="">
                <img src="css/vr3.jpg" class="swiper-slide" alt="">
                <img src="css/vr4.jpg" class="swiper-slide" alt="">
                <img src="css/vr5.jpg" class="swiper-slide" alt="">
                <img src="css/vr6.jpg" class="swiper-slide" alt="">
            </div>
  ...
  var swiper = new Swiper(".gallery-slider",{
                                ...
                                <div class="inner">
                                    ...
                                    <div class="room-price">
                                        <div class="price-head">
                                            ...
                                            <span class="price-value" style="text-decoration: line-through;">$125 / Night</span>
                                            <span class="price-value" style="color:red">$93.75/ Night</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h3>Room space</h3>
                                                <span><i class="fa-solid fa-gem"></i> 20m<sup>2</sup></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <div class="desc">
        ...
        <p style="text-align: justify;">
            Our Deluxe will make you completely forget that you’re on the edge of the bustling capital. With its size of 20 m², our Deluxe twin room is the largest room in the Amsterdam Forest Hotel.

The contemporary furnishing radiates warmth, luxury and tranquillity. Naturally, all rooms are fully equipped for entertainment and relaxation. Smart TV, WiFi, spacious rain shower with free products from The Spa Collection and a Nespresso machine. If you desire even more comfort than our Twin Deluxe has to offer, you are of course always welcome in our atmospheric lounge!
        </p>
        <p></p>
    </div>
